...
const validateGoogleSignup = (req: any, res: any, next: any) => {
...
const validateEmailSignup = (req: any, res: any, next: any) => {
  const { error } = emailSignupSchema.validate(req.body);
  if (error) {
    return res.status(400).json({
      success: false,
      message: "Validation error",
...
const validateGoogleLogin = (req: any, res: any, next: any) => {
...
const validateEmailLogin = (req: any, res: any, next: any) => {
...
const validateSetPassword = (req: any, res: any, next: any) => {
...
const validateChangePassword = (req: any, res: any, next: any) => {
...
const validateUpdateUserDetails = (req: any, res: any, next: any) => {
...
router.post("/login/email", validateEmailLogin, AuthController.loginWithEmail);
